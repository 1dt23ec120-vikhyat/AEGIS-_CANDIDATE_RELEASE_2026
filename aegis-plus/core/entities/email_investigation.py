"""Email investigation aggregate.

Analyst workflow metadata attached to an :class:`EmailScan`: an investigation
...
class EmailInvestigation(AggregateRoot):
    """Analyst annotations for an analyzed email."""
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            scan_id: The identifier of the associated email scan.
